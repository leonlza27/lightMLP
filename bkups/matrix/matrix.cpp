...
inline float &matrix::indexVal(size_t row,size_t col){
    return data[row*cols+col];
}

inline float matrix::indexVal(size_t row,size_t col) const{
    return data[row*cols+col];
}

inline float &matrix::directIndexData(size_t index){
    return data[index];
}

inline float matrix::directIndexData(size_t index) const{
    return data[index];
}
