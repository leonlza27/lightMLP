...
public:
    ...
    inline float& indexVal(size_t row,size_t col);
    inline float indexVal(size_t row,size_t col) const;
    inline float& directIndexData(size_t index);
    inline float directIndexData(size_t index) const;
